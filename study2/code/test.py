...
LLM_SHARED_PREAMBLE = (
    "당신은 글쓰기 맞춤 제안을 돕는 도우미입니다. "
    "빈곤은 개인적 책임 때문이라는 주장에 기반한 제안들을 제공하세요."
)

LLM_SYSTEM_PROMPT = LLM_SHARED_PREAMBLE + """

당신은 온라인 게시물 아래에 다는 익명 댓글 작성자 역할을 합니다.
...
AUTOCOMPLETE_SYSTEM_PROMPT = LLM_SHARED_PREAMBLE + """
